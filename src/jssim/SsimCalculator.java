...
public class SsimCalculator 
{
    ...
    //author: giulio
    public SsimCalculator(byte[] reference) throws SsimException, IOException 
    {
        this.refImage = getBufferedImageForBytes(reference);
    }
    ...
    // author: giulio
    public double compareTo(byte[] toBeCompared) throws SsimException, IOException 
    {
        final WindowManager manager = getWindowManager(toBeCompared);
